...
#[rustfmt::skip]
fn main() {
    let spec = DivisibleAssetSpec::new("RGBS", "RGBS", Precision::CentiMicro);
    ...
    const ISSUE: u64 = 21_000_000_000_000_000_00;
    ...
    eprintln!("{bindle}");
    bindle.save("interfaces/RGBS.rgb").expect("unable to save contract");
    fs::write("interfaces/RGBS.rgba", bindle.to_string()).expect("unable to save contract");
